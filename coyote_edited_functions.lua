...
----------------------
-- COYOTE CUSTOM: Remove RDRO cut scene as "outlaw/prisoner" since it's not our Lore
-- commenting out these below, removed the NPCs and scene. 
...
-- COYOTE NOTE: comment out this to remove police chief (seated): 
-- COYOTE NOTE: Original, 'MP_U_M_O_BlWPoliceChief_01' 
-- For Blood Moon Event, use: 're_frozentodeath_males_01'
...
-- COYOTE NOTE: comment out this to remove marshall (walking with rifle):   
-- COYOTE NOTES: Original, `CS_MP_MARSHALL_DAVIES`
-- For Blood Moon Event, use: 'MP_PREDATOR'
...
-- COYOTE NOTE: comment out this too:  
